...
public interface FOOLListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link FOOLParser#argdec}.
	 * @param ctx the parse tree
	 */
	void enterArgdec(FOOLParser.ArgdecContext ctx);
	/**
	 * Exit a parse tree produced by {@link FOOLParser#argdec}.
	 * @param ctx the parse tree
	 */
	void exitArgdec(FOOLParser.ArgdecContext ctx);
	/**
